...
// rather than honoured, because a wildcard here would re-open the hole this
// module exists to keep shut.
const DEFAULT_HOSTED_ORIGINS = ["https://rand0m.ai", "https://abc-rand0m-ai.web.app"];
...
class Pairing {
  ...
  constructor(cfg, { persist } = {}) {
    ...
    // restart cancels an unfinished pairing, which is the behaviour a
