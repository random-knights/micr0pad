...
// stg.rand0m.ai is the custom staging host the owner actually reviews on; it
// fronts the same abc site as abc-rand0m-ai.web.app but the browser sends its
// own name as the Origin, so without it here a pairing from the staging page
// is refused before any code is checked.
const DEFAULT_HOSTED_ORIGINS = [
  "https://rand0m.ai",
  "https://stg.rand0m.ai",
