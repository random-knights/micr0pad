...
// existing behavior (auto mode uses each status's own effect, fixed mode uses
...
// "wave" - snake is the traveling one, rainbow the color-cycling one.
const underglowEffects = [
  ...
  { id: 2, label: "Spin", hint: "snake - the traveling effect" },
